 ...
 */
public final class PresentWireCompiler {
  ...
  PresentWireCompiler(FileSystem fs, WireLogger log, List<String> protoPaths, String javaOut,
  ...
  public static void main(String... args) throws IOException {
    try {
      PresentWireCompiler wireCompiler = forArgs(args);
  ...
  static PresentWireCompiler forArgs(String... args) throws WireException {
    return forArgs(FileSystems.getDefault(), new ConsoleWireLogger(), args);
  }

  static PresentWireCompiler forArgs(
    ...
    return new PresentWireCompiler(fileSystem, logger, protoPaths, javaOut, sourceFileNames,
  ...
  void compile() throws IOException {
    PresentSchemaLoader schemaLoader = new PresentSchemaLoader();
